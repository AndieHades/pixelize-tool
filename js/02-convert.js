    ...
    function rotSprite(src, w, h, ang, scale) { // src: Int32Array (0 = прозрачно)
      ...
      for (let oy = 0; oy < oH; oy++) for (let ox = 0; ox < oW; ox++) {
        f.clear(); let best = 0, bn = -1, bl = -1; // мода блока; при равенстве — непрозрачный и более светлый (как в cleanEdge)
