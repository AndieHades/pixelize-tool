...
export const LONG_PRESS_MS = 480;   // долгий тап → меню (палитра)
export const LIFT_MS = 160;         // удержание (зажатый тап/нажатие) → поднять строку под перенос (мышь: сдвиг начинает drag сразу)
