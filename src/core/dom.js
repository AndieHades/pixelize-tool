...
const MENU_IDS = ['ctx', 'lctx', 'cctx', 'sctx', 'trctx', 'fxctx', 'impmenu', 'setmenu', 'tctx', 'rowctx', 'brush-plus', 'brush-choice', 'line-choice', 'shape-choice', 'sym-choice', 'flip-choice', 'tile-menu', 'tile-cctx', 'tilegrid-pop'];
