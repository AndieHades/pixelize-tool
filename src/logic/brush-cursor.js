...
// Переиспользует ядро brush-stamp — без дублирования алгоритма маски.
// Без DOM и state.
import { brushMask, stampSize } from './brush-stamp.js';
...
export function footprintMask(sb, slider, smax) {
  if (sb) return brushMask(sb, stampSize(sb, slider, smax));
