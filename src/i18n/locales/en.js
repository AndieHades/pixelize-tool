...
export const en = {
  ...
  'side.bc': 'Brightness/contrast', 'side.imageSettings': 'Settings', 'side.crop': 'Crop (C)', 'side.trim': 'Trim', 'side.center': 'Center',
  ...
  'crop.center': 'From center (Shift)', 'crop.apply': 'Apply crop (Enter)', 'crop.cancel': 'Cancel (Esc)',
  'crop.units': 'Units',
  ...
  // Tileset / Tilemap
  'side.tilemap': 'Tileset mode', 'tool.tilebrush': 'Tile brush',
  'tile.copy': 'Copy', 'tile.cut': 'Cut', 'tile.paste': 'Paste',
  'tile.fromLayer': 'Create tile from layer',
  'tile.manual': 'Manual', 'tile.auto': 'Auto',
  ...
  'tile.draw': 'Draw tiles', 'tile.tileset': 'Tileset', 'tile.addToSet': 'Add tile',
