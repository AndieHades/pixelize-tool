...
export const en = {
  ...
  'tool.rect': 'Rectangle (K)', 'tool.rectFill': 'Filled rectangle (K)',
  ...
  'brush.library': 'Brushes', 'brush.add': 'Add set', 'brush.newSet': 'Create new set', 'brush.import': 'Import from Files',
  ...
  'tool.select': 'Selection (M)', 'tool.lasso': 'Lasso', 'tool.layers': 'Layers (L)', 'tool.color': 'Color',
  ...
  'side.symmetry': 'Symmetry (S)', 'side.symV': 'Horizontal symmetry (S)', 'side.symH': 'Vertical symmetry (Shift+S)', 'side.symD1': 'Diagonal symmetry 45°', 'side.symD2': 'Diagonal symmetry -45°', 'side.symBoth': 'Multiple symmetry axes',
  'side.symMove': 'Move symmetry line', 'side.symReset': 'Reset symmetry line', 'side.grid': 'Grid', 'side.tile': 'Tile mode (Z)',
  ...
  'side.bc': 'Brightness/contrast', 'side.imageSettings': 'Settings', 'side.crop': 'Canvas size (C)', 'side.trim': 'Trim', 'side.center': 'Center',
  ...
  'crop.canvasSize': 'Canvas size', 'crop.custom': 'Custom', 'crop.center': 'From center (Shift)', 'crop.apply': 'Apply crop (Enter)', 'crop.cancel': 'Cancel (Esc)',
  'crop.units': 'Cells', 'crop.gridVisible': 'Show grid', 'crop.cellSize': 'Cell size',
  ...
  'btn.tsgAddFull': 'Add', 'btn.tsgCreateFull': 'New palette', 'btn.tsgClearFull': 'Clear',
  ...
  'menu.convertTile': 'Convert to Tilemap', 'menu.convertLayer': 'Convert to Layer', 'side.tileLayer': 'Tilemap', 'tile.random': 'Random',
  ...
  'tile.palette': 'Tiles', 'tile.newLayer': 'New Tilemap', 'tile.tilemapLayer': 'Tilemap',
