...
export const ru = {
  ...
  'tool.lineStraight': 'Линия (U) · Shift — 45°/90°',
  'tool.lineContour': 'Контур: круглая кисть, замкнуть и залить',
  ...
  'tool.rect': 'Прямоугольник (K) · Shift — квадрат', 'tool.rectFill': 'Залитый прямоугольник (K) · Shift — квадрат',
  'tool.ellipse': 'Эллипс (Q) · Shift — круг', 'tool.ellipseFill': 'Залитый эллипс (Q) · Shift — круг',
  ...
  // боковая панель
  'side.symmetry': 'Симметрия (S / Shift+S)', 'side.symV': 'Симметрия лево-право (S)', 'side.symH': 'Симметрия верх-низ (Shift+S)', 'side.symD1': 'Диагональная симметрия 45°', 'side.symD2': 'Диагональная симметрия -45°', 'side.symBoth': 'Несколько осей симметрии',
  'side.symMove': 'Переместить линию симметрии', 'side.symReset': 'Сбросить линию симметрии в центр', 'side.grid': 'Сетка', 'side.tile': 'Режим тайла (бесшовный 3×3)',
  ...
  'tile.manual': 'Manual: правка исходного тайла (все экземпляры)', 'tile.auto': 'Auto: новый тайл из клетки',
  ...
  'tile.draw': 'Рисовать тайлами (вкл/выкл)', 'tile.tileset': 'Tileset', 'tile.addToSet': 'Add to tileset',
