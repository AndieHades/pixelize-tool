...
export const ru = {
  ...
  'side.stab': 'Стабилизация штриха (T)', 'side.outline': 'Обводка контуром (O)', 'side.transformCanvas': 'Трансформировать холст',
  'side.flipH': 'Отразить по горизонтали (H)',
  'side.flipV': 'Отразить по вертикали (V)', 'side.rotate': 'Повернуть 90° (R)', 'side.mono': 'Монохром',
  'side.bc': 'Яркость/контраст', 'side.imageSettings': 'Настройки', 'side.crop': 'Размер холста (C)', 'side.trim': 'Обрезать', 'side.center': 'Центрировать', 'side.centerFit': 'Подогнать',
  ...
  'new.sprites': 'Спрайты', 'new.gameFrames': 'Кадры', 'new.saved': 'Сохранённые', 'new.custom': 'Свой',
  'new.savePreset': 'Сохранить пресет', 'new.savedEmpty': 'Пока пусто', 'new.colorMode': 'Цветовой режим',
  'new.modeRgba': 'RGBA', 'new.modeGray': 'Градации серого',
  'new.background': 'Фон холста', 'new.bgTransparent': 'Прозрачный', 'new.bgWhite': 'Белый', 'new.bgBlack': 'Чёрный',
  'tilemap.tileset': 'Тайлсет', 'tilemap.newTileset': 'Новый тайлсет', 'tilemap.saved': 'Пресеты',
  'tilemap.savedEmpty': 'Нет сохранённых пресетов', 'tilemap.settings': 'Настройки тайлмапа', 'tilemap.custom': 'Свой', 'tilemap.name': 'Имя',
  'tilemap.gridW': 'Ширина сетки', 'tilemap.gridH': 'Высота сетки', 'tilemap.savePreset': 'Сохранить пресет', 'tilemap.resizeCanvas': 'Подогнать холст',
  'label.name': 'Имя',
  ...
  'pop.shadow': 'Тень', 'pop.outline': 'Обводка',
  ...
  // кнопки
  'btn.apply': 'Применить', 'btn.cancel': 'Отмена', 'btn.close': 'Закрыть', 'btn.save': 'Сохранить', 'btn.clear': 'Очистить', 'btn.create': 'Создать', 'btn.ok': 'ОК',
  ...
  // коррекция
  'adj.dodge': 'Осветление', 'adj.burn': 'Затемнение', 'adj.colorize': 'Окрашивание', 'adj.mono': 'Монохром',
  // меню слоя
  ...
  'menu.symm': 'Симметрировать слой', 'menu.transform': 'Трансформировать…', 'menu.shadow': 'Тень…',
  ...
  'palette.menu': 'Палитры', 'palette.namePlaceholder': 'Имя палитры', 'palette.defaultName': 'Палитра {n}', 'palette.apollo': 'Apollo 46', 'palette.addActiveTitle': 'Добавить цвет',
  ...
  'shade.title': 'Тонирование', 'shade.pickColors': 'Выбрать цвета', 'tool.brushShading': 'Кисть-тонирование',
  'menu.pickLayer': 'Слой:',
  'crop.canvasSize': 'Размер холста', 'crop.custom': 'Свой', 'crop.center': 'От центра (Shift)', 'crop.apply': 'Применить кроп (Enter)', 'crop.cancel': 'Отмена (Esc)',
  'crop.units': 'Клетки', 'crop.gridVisible': 'Показать сетку', 'crop.cellSize': 'Размер клетки',
  ...
  'toast.layerEmpty': 'Слой пуст', 'toast.centered': 'Объект отцентрирован', 'toast.fitShortSide': 'Объект подогнан к холсту',
  ...
  'tile.manual': 'Редактировать все тайлы', 'tile.auto': 'Рисовать на тайле',
  ...
  'menu.convertTile': 'Преобразовать в тайлмап', 'menu.convertLayer': 'Преобразовать в слой', 'side.tileLayer': 'Тайлмап', 'tile.random': 'Случайно',
  'tile.place': 'Поставить тайл', 'tile.draw': 'Поставить тайл', 'tile.tileset': 'Тайлсет', 'tile.addToSet': 'Добавить тайл',
  'tile.select': 'Выделить клетку', 'tile.fill': 'Залить клетку',
  'tile.palette': 'Тайлы', 'tile.newLayer': 'Новый тайлмап', 'tile.tilemapLayer': 'Тайлмап',
  ...
  'tile.exportData': 'Экспорт тайлсета и тайлмапа', 'tile.applyArea': 'К выделенной области', 'tile.applyLayer': 'Ко всему слою',
  ...
  'toast.needTilemapLayer': 'Сначала выберите тайлмап-слой', 'toast.tilemapCreated': 'Тайлмап-слой создан',
  'toast.tileMadeUnique': 'Создан уникальный тайл', 'toast.tilesBaked': 'Тайлмап запечён в пиксели',
  'toast.noTiles': 'Сначала создайте тайл', 'toast.tilesReplaced': 'Заменено клеток: {n}', 'toast.noTilemap': 'Нет тайлмап-слоёв',
